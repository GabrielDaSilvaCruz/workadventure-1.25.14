        ...
        this.socket.onmessage = (messageEvent) => {
            ...
            switch (message.$case) {
                ...
                case "roomJoinedMessage": {
                    ...
                    this.canEdit = true; // roomJoinedMessage.canEdit;
                    console.log("Map Editor Debug: ENABLE_MAP_EDITOR =", ENABLE_MAP_EDITOR);
                    console.log("Map Editor Debug: canEdit =", this.canEdit);
                    console.log("Map Editor Debug: isAdmin =", this.isAdmin());
                    console.log("Map Editor Debug: tags =", this.tags);
